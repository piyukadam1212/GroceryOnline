						...
						<tbody>
							<tr class="rem1">
								...
								<td class="invert-image">
									<a href="single2">
										<img src="<c:url value="/resources/images/a7.jpg"  class="img-responsive"/>"/>
							...
							<tr class="rem2">
								...
								<td class="invert-image">
									<a href="single2">
										<img src="<c:url value="/resources/images/s6.jpg"/> class="img-responsive" />
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
							...
							<tr class="rem3">
								...
								<td class="invert-image">
									<a href="single">
										<img src="<c:url value="/resources/images/s5.jpg"/> class="img-responsive"/>
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
