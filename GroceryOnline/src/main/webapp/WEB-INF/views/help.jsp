...
<title>Grocery Shoppy an Ecommerce Category Bootstrap Responsive
	Web Template | Help :: w3layouts</title>
<!--/tags -->
	...
	<div class="header-bot">
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-4 logo_agile">
				<h1>
					<a href="index"> <span>G</span>rocery <span>S</span>hoppy
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock"
							...
							<ul class="nav navbar-nav menu__list">
								<li><a class="nav-stylehead" href="index">Home <span
										class="sr-only">(current)</span>
								</a></li>
								<li class=""><a class="nav-stylehead" href="about">About
										Us</a></li>
										...
										<div class="agile_inner_drop_nav_info">
											<div class="col-sm-4 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li><a href="product">Bakery</a></li>
													<li><a href="product">Baking Supplies</a></li>
													<li><a href="product">Coffee, Tea & Beverages</a>
													</li>
													<li><a href="product">Dried Fruits, Nuts</a></li>
													<li><a href="product">Sweets, Chocolate</a></li>
													<li><a href="product">Spices & Masalas</a></li>
													<li><a href="product">Jams, Honey & Spreads</a></li>
												</ul>
											</div>
											<div class="col-sm-4 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li><a href="product">Pickles</a></li>
													<li><a href="product">Pasta & Noodles</a></li>
													<li><a href="product">Rice, Flour & Pulses</a></li>
													<li><a href="product">Sauces & Cooking Pastes</a>
													</li>
													<li><a href="product">Snack Foods</a></li>
													<li><a href="product">Oils, Vinegars</a></li>
													<li><a href="product">Meat, Poultry & Seafood</a>
													</li>
												</ul>
											</div>
											<div class="col-sm-4 multi-gd-img">
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											<div class="col-sm-6 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li><a href="product2">Kitchen & Dining</a></li>
													<li><a href="product2">Detergents</a></li>
													<li><a href="product2">Utensil Cleaners</a></li>
													<li><a href="product2">Floor & Other Cleaners</a>
													</li>
													<li><a href="product2">Disposables, Garbage
															Bag</a></li>
													<li><a href="product2">Repellents &
															Fresheners</a></li>
													<li><a href="product2"> Dishwash</a></li>
												</ul>
											</div>
											<div class="col-sm-6 multi-gd-img">
												<ul class="multi-column-dropdown">
													<li><a href="product2">Pet Care</a></li>
													<li><a href="product2">Cleaning Accessories</a></li>
													<li><a href="product2">Pooja Needs</a></li>
													<li><a href="product2">Crackers</a></li>
													<li><a href="product2">Festive Decoratives</a></li>
													<li><a href="product2">Plasticware</a></li>
													<li><a href="product2">Home Care</a></li>
												</ul>
											</div>
											<div class="clearfix"></div>
										</div>
									</ul></li>
								<li><a class="nav-stylehead" href="faqs">Faqs</a></li>
								<li class="dropdown"><a
		...
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						...
						<a href="#"> <img src="<c:url value="/resources/images/1.png" />"/>
						</a> <a href="#"> <img src="<c:url value="/resources/images/2.png" />"/>
						</a>
						<div class="clearfix"></div>
					</div>
				</div>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li><img src="<c:url value="/resources/images/pay2.png" />"/></li>
						<li><img src="<c:url value="/resources/images/pay5.png" />"/></li>
						<li><img src="<c:url value="/resources/images/pay1.png" />"/></li>
						<li><img src="<c:url value="/resources/images/pay4.png" />"/></li>
						<li><img src="<c:url value="/resources/images/pay6.png" />"/></li>
						<li><img src="<c:url value="/resources/images/pay3.png" />"/></li>
						<li><img src="<c:url value="/resources/images/pay7.png" />"/></li>
						<li><img src="<c:url value="/resources/images/pay8.png" />"/></li>
						<li><img src="<c:url value="/resources/images/pay9.png" />"/></li>
					</ul>
				</div>
				<!-- //payment -->
			</div>
