						...
						<ul class="slides">
							<li data-thumb="images/si.jpg">
								<div class="thumb-image">
									<img src="<c:url value="/resources/images/si.jpg" data-imagezoom="true" class="img-responsive" />"/> </div>
							</li>
							<li data-thumb="images/si2.jpg">
								<div class="thumb-image">
									<img src="<c:url value="/resources/images/si2.jpg" data-imagezoom="true" class="img-responsive" />"/> </div>
							</li>
							<li data-thumb="images/si3.jpg">
								<div class="thumb-image">
									<img src="<c:url value="/resources/images/si3.jpg" data-imagezoom="true" class="img-responsive" />"/> </div>
							</li>
						</ul>
						<div class="clearfix"></div>
					</div>
