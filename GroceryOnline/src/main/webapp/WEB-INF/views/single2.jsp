						...
						<ul class="slides">
							<li data-thumb="images/se1.jpg">
								<div class="thumb-image">
									<img src="<c:url value="/resources/images/se1.jpg" data-imagezoom="true" class="img-responsive" />"/> </div>
							</li>
							<li data-thumb="images/se2.jpg">
								<div class="thumb-image">
									<img src="<c:url value="/resources/images/se2.jpg" data-imagezoom="true" class="img-responsive" />"/> </div>
							</li>
							<li data-thumb="images/se3.jpg">
								<div class="thumb-image">
									<img src="<c:url value="/resources/images/se3.jpg" data-imagezoom="true" class="img-responsive" />"/> </div>
							</li>
						</ul>
						<div class="clearfix"></div>
					</div>
